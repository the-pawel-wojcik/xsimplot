...
def find_spectrum_files(
    ...
    if args is not None and args.spectrum_files is not None:
...
def main():
    ...
    spectrum_files = find_spectrum_files(config, args)
    ...
    *xlims, gamma = find_left_right_gamma(spectra, args, config)
    ...
    if "reference_spectrum" in config:
        for ref_spec_conf in config['reference_spectrum']:
            spectrum_files = find_spectrum_files(ref_spec_conf)
